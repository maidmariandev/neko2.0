...
func (WebRTC) Init(cmd *cobra.Command) error {
	...
	cmd.PersistentFlags().StringSlice("iceserver", []string{"stun:142.93.0.177:3478"}, "describes a single STUN and TURN server that can be used by the ICEAgent to establish a connection with a peer")
